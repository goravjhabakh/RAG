...
async def create_book(book: Dict[str, Any]) -> str:
    res = collection.insert_one(book)
    logger.info(f"Inserted book with ID: {res.inserted_id}")
    return str(res.inserted_id)

async def get_book(id: int) -> Optional[Dict[str,Any]]:
